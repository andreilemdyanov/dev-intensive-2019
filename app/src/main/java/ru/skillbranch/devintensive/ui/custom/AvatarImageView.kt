...
//        Log.e("M_AvatarImageViewMask", "onMeasure")
...
//        Log.e("M_AvatarImageViewMask", "onSizeChanged")
        if (w == 0) return
        with(viewRect) {
            left = 0
            top = 0
...
//        super.onDraw(canvas)
//        Log.e("M_AvatarImageViewMask", "onDraw")
...
//        if (letters == "") return 0
        Log.d("M_AvatarImageView", "Input initials = $letters")
